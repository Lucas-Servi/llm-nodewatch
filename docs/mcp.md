...
Expose your nodewatch data to AI assistants (Claude, etc.) via the [Model Context Protocol](https://modelcontextprotocol.io). The MCP server runs locally over stdio and gives any MCP-compatible client full read access to your execution traces.
